package com.bank.bian.tradeordermanagement.model;
...
/**
 * The BIAN control record for this service domain: "Trade Order Management Plan".
 *
 ...
 * to its asset type (Trade Order). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Trade Order Management Plan";
